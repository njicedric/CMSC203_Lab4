...
public class TwoDimArrayPractice extends JFrame
{
   ...
   */
   public void printArray( )
   {
    ...
    for (int row = 0; row < intArray.length; row++) {
        for (int column = 0; column < intArray[row].length; column++) {
            System.out.print(intArray[row][column] + " "); // Print each element
            animate(row, column); // Visualize the array
        }
   ...
   */
   public void setValues( int value, int row )
   {
    ...
    for (int column = 0; column < intArray[row].length; column++) {
        intArray[row][column] = value; // Set each element in the row to the specified value
        animate(row, column); // Visualize the array
    }
   ...
   */
   public int findMinimum(int column) {
	    ...
	    for (int row = 0; row < intArray.length; row++) {
	        ...
	        // Animate the algorithm to visualize the process
	        animate(row, column, min); // Pass the current minimum to animate
	    }
   ...
   */
   public int countFound(int value) {
	    ...
	    for (int row = 0; row < intArray.length; row++) {
	        for (int column = 0; column < intArray[row].length; column++) {
	            // If the current element matches the specified value, increment the counter
	    ...
	    // Return the total count of the specified value
	    return count;
	}
